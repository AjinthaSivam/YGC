...
const NewChatButton = ( {handleNewChat} ) => {
  return (
    <div className='relative group'>
        <button onClick={handleNewChat} className='flex items-center text-primary hover:bg-primary hover:rounded-full p-2 hover:text-light_gray' aria-label='New Chat'>
